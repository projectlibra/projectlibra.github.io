...
- [1) Build and Run](#1--build-and-run)
  * [Building the Client](#building-the-client)
    + [Install React JS](#install-react-js)
    + [Install dependencies](#install-dependencies)
    + [Setting up the HOST IP](#setting-up-the-host-ip)
    + [Running the client](#running-the-client)
  * [Building the Server](#building-the-server)
    + [Installing dependencies](#installing-dependencies)
    + [Setting up a PostgreSQL Server](#setting-up-a-postgresql-server)
    + [Setting up SnpEff](#setting-up-snpeff)
    + [Running the Server](#running-the-server)
- [2) Usage of LIBRA: Registration and Profile](#2--usage-of-libra--registration-and-profile)
  * [Homepage](#homepage)
  * [Sign Up](#sign-up)
  * [Login](#login)
- [3) Usage of LIBRA: VCF Upload, Annotation and Filtering](#3--usage-of-libra--vcf-upload--annotation-and-filtering)
  * [My Projects](#my-projects)
  * [Create a New Project](#create-a-new-project)
  * [Project Details](#project-details)
    + [Project summary](#project-summary)
    + [VCF upload](#vcf-upload)
    + [Project Notes](#project-notes)
    + [ProjectPatients](#projectpatients)
- [4) Usage of LIBRA: Match Maker](#4--usage-of-libra--match-maker)
  * [Create New Patient](#create-new-patient)
  * [See Overall View for Patients](#see-overall-view-for-patients)
  * [See Details for a Patient](#see-details-for-a-patient)
  * [Editing a Patient](#editing-a-patient)
  * [Get Highly Affected Genes For a Patient](#get-highly-affected-genes-for-a-patient)
  * [HPO traverser](#hpo-traverser)
  * [Automated Similarity Notification System](#automated-similarity-notification-system)
  * [Manual Similarity System](#manual-similarity-system)
  * [Similarity Threshold Configuration](#similarity-threshold-configuration)
## 1) Build and Run
